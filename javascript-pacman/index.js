...
class Player {
  constructor({ position, velocity }) {
    (this.position = position), (this.velocity = velocity), (this.radius = 15);
  }
...
class Pellet {
  constructor({ position }) {
    (this.position = position), (this.radius = 3);
  }
      ...
      case "1":
        boundaries.push(
          new Boundary({
            ...
            image: createImg("./images/pipeCorner1.png"),
          })
        );
        break;
      case "2":
        boundaries.push(
          new Boundary({
            ...
            image: createImg("./images/pipeCorner2.png"),
          })
        );
        break;
      case "3":
        boundaries.push(
          new Boundary({
            ...
            image: createImg("./images/pipeCorner3.png"),
          })
        );
        break;
      case "4":
        boundaries.push(
          new Boundary({
            ...
            image: createImg("./images/pipeCorner4.png"),
          })
        );
        break;
      case "b":
      ...
      case "5":
        boundaries.push(
          new Boundary({
            ...
            color: "blue",
            image: createImg("./images/pipeConnectorTop.png"),
          })
        );
        break;
      case "6":
        boundaries.push(
          new Boundary({
            ...
            color: "blue",
            image: createImg("./images/pipeConnectorRight.png"),
          })
        );
        break;
      case "7":
        boundaries.push(
          new Boundary({
            ...
            color: "blue",
            image: createImg("./images/pipeConnectorBottom.png"),
          })
        );
        break;
      case "8":
        boundaries.push(
          new Boundary({
            ...
            image: createImg("./images/pipeConnectorLeft.png"),
          })
        );
        break;
